# Arquivo arquivado: test_render_invite.py
# Este script foi movido para o diretório 'scripts/archived' durante a limpeza agressiva.
# Mantido apenas para referência histórica. Não deve ser executado em produção.

# Conteúdo original salvo para auditoria.
